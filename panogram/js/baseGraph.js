...
BaseGraph.prototype = {
    ...
    getMaternalGrandmother : function(v) {
        var mother = this.getMother(v);
        return this.getMother(mother);

    },

    getMaternalGrandfather : function(v) {
        var mother = this.getMother(v);
        return this.getFather(mother);

    },

    getPaternalGrandmother : function(v) {
        var father = this.getFather(v);
        return this.getMother(father);
    },

    getPaternalGrandfather : function(v) {
        var father = this.getFather(v);
